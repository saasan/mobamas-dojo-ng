...
(function() {
  ...
  Birthday = function() {
    ...
    this._data[1][21] = '福山舞、松山久美子、四条貴音';
    ...
    this._data[10][6] = '乙倉悠貴';
    this._data[10][7] = '砂塚あきら';
    this._data[10][9] = '浅利七海';
    ...
    this._data[11][5] = '辻野あかり';
    this._data[11][6] = '間中美里';
    this._data[11][7] = '八神マキノ';
    this._data[11][10] = '黒埼ちとせ';
